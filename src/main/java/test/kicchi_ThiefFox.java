...
public class kicchi_ThiefFox {
    ...
    public static void main(String[] args) {
        ...
        if (isSuspected(fox1WearsCoat, fox1CoatColor, fox1HasATorch, fox1BagCount)){
    ...
    public static boolean isSuspected(boolean wearsCoat, String coatColor, boolean hasTorch, int bagCount){
        return wearsCoat && coatColor.equalsIgnoreCase("black") && hasTorch && bagCount == 3;
    }
