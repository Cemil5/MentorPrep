...
public class CodeReview_AfterRefactoring {
    ...
    public static void eligibleToVote1(int age, boolean isAmerican) {
        ...
        if (age >= 18 && isAmerican) {                  // no need to write "isAmerican == true"
    ...
    public static void eligibleToVote(int age, boolean isAmerican) {
        ...
        isEligible = age >= 18 && isAmerican;    // can be simplified
    ...
    public static void month(String monthName) {
        ...
        switch (monthName) {
            case "January":  case "March":   case "May":                            // can be converted to switch case
                numDays = 31;
                break;
            case "February":
                numDays = 28;
    ...
    public static void divisibleBy() {
        ...
        for (int i = 0; i <= N; i++) {
            if ((i % 15 == 0)) {    // should be simplified
                divisibleBy15 += " " + i;
            }                                               // else if
